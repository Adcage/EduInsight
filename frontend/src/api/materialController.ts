...
/** 获取资料详情 获取资料详情</br></br>返回资料的完整信息，包括关联的标签、分类、课程等。 GET /api/v1/materials/${param0} */
export async function materialApiIntMaterialIdGet(
  ...
  return request<API.MaterialDetailResponseModel>(`/api/v1/materials/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
...
/** 更新资料信息 更新资料信息</br></br>只有资料的上传者可以更新。</br>可以更新标题、描述、分类和标签。 PUT /api/v1/materials/${param0} */
export async function materialApiIntMaterialIdPut(
  ...
  const { materialId: param0, ...queryParams } = params
  return request<API.MaterialResponseModel>(`/api/v1/materials/${param0}`, {
    method: 'PUT',
    headers: {
...
/** 删除资料 删除资料</br></br>只有资料的上传者可以删除。</br>删除资料会同时删除文件和数据库记录。 DELETE /api/v1/materials/${param0} */
export async function materialApiIntMaterialIdDelete(
  ...
  const { materialId: param0, ...queryParams } = params
  return request<API.MessageResponseModel>(`/api/v1/materials/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function materialApiIntMaterialIdDownloadGet(
  ...
  const { materialId: param0, ...queryParams } = params
  return request<any>(`/api/v1/materials/${param0}/download`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
