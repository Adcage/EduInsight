  ...
  <div class="location-picker-container">
    <div class="location-display">
      ...
      <div v-else-if="locationError" class="location-error">
        <a-alert :message="locationError" type="error" show-icon />
        <a-button type="primary" @click="getCurrentLocation" style="margin-top: 12px">
...
import { EnvironmentOutlined, AimOutlined, ReloadOutlined } from '@ant-design/icons-vue'
