<template>
  <div class="user-management">
    <a-card :bordered="false">
      ...
      <div class="toolbar">
        <div class="toolbar-left">
          <a-input-search v-model:value="searchKeyword" placeholder="搜索用户名、姓名、邮箱或工号" style="width: 300px"
                          @search="handleSearch"/>
          <a-select v-model:value="filterRole" allow-clear placeholder="角色筛选"
                    style="width: 120px; margin-left: 12px" @change="handleSearch">
        ...
        <div class="toolbar-right">
          ...
          <a-button :disabled="selectedRowKeys.length === 0" danger style="margin-left: 8px" @click="handleBatchDelete">
            <template #icon>
              <DeleteOutlined/>
            </template>
            批量删除
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'action'">
            <a-space>
              ...
              <a-popconfirm cancel-text="取消" ok-text="确定" title="确定要删除该用户吗?"
    ...
    <!-- 添加/编辑用户弹窗 -->
    <UserForm v-model:visible="formVisible" :is-edit="isEdit" :user-data="currentUser" @success="handleFormSuccess"/>
...
import {userApiIntUserIdDeactivatePost, userApiListGet} from '@/api/userController'
