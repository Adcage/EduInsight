...
/** 获取标签详情 获取标签详情</br></br>返回指定标签的详细信息。 GET /api/v1/material-tags/${param0} */
export async function tagApiIntTagIdGet(
  ...
  return request<API.MaterialTagResponseModel>(`/api/v1/material-tags/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
...
/** 删除标签 删除标签</br></br>只能删除未被使用的标签。</br>只有管理员和教师可以删除标签。 DELETE /api/v1/material-tags/${param0} */
export async function tagApiIntTagIdDelete(
  ...
  const { tagId: param0, ...queryParams } = params
  return request<API.MessageResponseModel>(`/api/v1/material-tags/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
    ...(options || {}),
  })
